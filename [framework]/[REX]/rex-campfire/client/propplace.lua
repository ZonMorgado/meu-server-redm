    ...
    CreateThread(function()
        while not confirmed do
            ...
            if PromptHasHoldModeCompleted(SetPrompt) then
                ...
                DeleteObject(prop)
                TriggerEvent('rex-campfire:client:setupcampfire', coords, heading, propmodel, item)
            end
...
RegisterNetEvent('rex-campfire:client:createcampfire', function(propmodel, item)
