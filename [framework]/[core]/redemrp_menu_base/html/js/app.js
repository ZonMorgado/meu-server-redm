(function () {
    let MenuTpl =
        ...
        '<img style="width: 100px ;height: 75px;background-image: url(nui://redemrp_menu_base/html/slot-bk.png);background-blend-mode: screen;background-repeat: round;align-content: center;padding: 10px;" src={{{src}}}>' +
