...
-- give reward
RegisterServerEvent('rsg-blackwaterbankheist:server:reward')
AddEventHandler('rsg-blackwaterbankheist:server:reward', function()
    local src = source
...
-- remove item
RegisterNetEvent('rsg-blackwaterbankheist:server:removeItem', function(item, amount)
    local src = source
    local Player = RSGCore.Functions.GetPlayer(src)
