...
RegisterNetEvent('stx-IDCard:client:openRegister',function(data)
...
RegisterNUICallback('create',function(data)
    ...
    TriggerServerEvent('stx-IDCard:server:createIDCard',data)
end)
RegisterNUICallback('close',function(data)
    SetNuiFocus(false,false)
end)

RegisterNetEvent('stx-IDCard:client:openIDCard',function(item,coords)
        ...
        for k,v in pairs(Config.Towns) do
            ...
            if dist < 3 and v.NPC then
                ...
                if PromptHasHoldModeCompleted(movements[1]) then
                    Wait(50)
                    TriggerServerEvent('stx-IDCard:server:openRegister', k)
                end
