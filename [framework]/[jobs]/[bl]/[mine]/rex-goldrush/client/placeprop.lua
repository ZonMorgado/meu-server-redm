...
function PropPlacer(proptype, prop, item)
    ...
    while true do
        ...
        if PromptHasHoldModeCompleted(SetPrompt) then
            ...
            TriggerEvent('rex-goldrush:client:placeNewProp', proptype, PropHash, item, pPos, heading )
...
RegisterNetEvent('rex-goldrush:client:createprop', function(proptype, prop, item)
