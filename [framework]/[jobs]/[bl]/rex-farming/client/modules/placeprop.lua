...
function PropPlacer(outputitem, prop, inputitem)
    ...
    while true do
        ...
        if PromptHasHoldModeCompleted(SetPrompt) then
            ...
            TriggerEvent('rex-farming:client:plantnewseed', outputitem, inputitem, PropHash, pPos, heading )
...
RegisterNetEvent('rex-farming:client:preplantseed', function( outputitem, prop, inputitem )
